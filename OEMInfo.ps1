...
if (!($SupportUrl)){$SupportUrl = "https://helpdesk.stratumreservoir.com/support/home"}


$cs = Get-WmiObject -Class Win32_ComputerSystem
#$manufacturer = $cs.Manufacturer
$manufacturer = "Stratum Reservoir"
$model = $cs.Model
...
$LogoURL = "https://raw.githubusercontent.com/arewecse/STM/refs/heads/main/Logo.bmp"
